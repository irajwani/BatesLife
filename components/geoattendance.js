...
export default class GeoAttendance extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      initialTime: 'unknown',
      initialMinute: 0,
      currentPosition: 'unknosehgejglwn',
      currentLatitude: '',
      currentLongitude: '',
      currentTime: 0.001,
      currentMinute: 0.01,
  ...
  render() {
    ...
    if ( //need to adjust coordinates
      ...
      if ( Math.abs(this.state.currentMinute-this.state.initialMinute) < 55 ) {
