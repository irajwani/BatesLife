...
//this.setState({body: title});
var url = "http://www.nescac.com/sports/mbkb/2017-18/schedule?print=rss";
...
// });
    ...
    return (
      ...
      <Text> Name of Da Gde: {this.state.title_1}  </Text>
      <Text> When: {this.state.date_1} </Text >
      <Text> What happened there?: {this.state.desc_1} </Text>
